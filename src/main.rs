    ...
    match node {
        NodeType::Tezedge => {
            response = 
                ...
                //reqwest::blocking::get("http://babylon.tezedge.com:38732/chains/main/blocks/head")?;
        }
        NodeType::Ocaml => { 
            response = 
                reqwest::blocking::get("http://ocaml-node-run:8732/chains/main/blocks/head")?;
                //reqwest::blocking::get("http://alphanet.simplestaking.com:8732/chains/main/blocks/head")?;
        }
    }
